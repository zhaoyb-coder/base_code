package com.gz.service.sys.role;
...
import com.gz.dao.sys.role.RoleDao;
...
public class RoleService extends BaseService{
	 ...
	 * @throws Exception
	 */
	public Map<String,Object> role_list(Map<String,String> params,int from,int pageSize) throws Exception{
		return queryForPage("role_list", params, from, pageSize);
	}
	...
	public String update(MultipartFile uploadFile,User user,String uploadFilePath) throws Exception{
		...
		//保存信息
		roleDao.update("updateModal", user);
	...
	public String delete_user(String[] userids){
		...
		for(String userid : userids){
			roleDao.delete("deleteModal", userid);
		}
	...
	public JSONObject queryById(String userid){
		Map<String,Object> map = roleDao.queryOneMap("queryById", userid);
	...
	/**
	 * 通过userid 获取user菜单详细信息
	 * @param userid
	 * @return
	 */
	public JSONObject queryMenuByUser(String userid){
		Map<String,Object> map = roleDao.queryOneMap("queryMenuByUser", userid);
	...
	public JSONArray queryMenu(String roleid){
		List<Map<String,Object>> map = roleDao.queryListMap("queryMenu", roleid);
		
		JSONArray jsonObject = JSONArray.parseArray(JSON.toJSONString(map));
		return jsonObject;
	}
