...
/**
 * @ClassName: EncodeHelper
 * @Description: 对通用查询的字符进行编码、解码帮助类
 * <p>Copyright: Copyright (c) 2018 </p>
 * <p>Company: DOE</p>
 * @author ZYB 
 * @date 2018-7-23 上午11:08:00
 * @version V1.0
 */
public class DoeCodeHelper {
	 ...
	 * @return
	 */
	public static String decodeStrQuery(String strquery) {
		if(strquery != null && !"".equals(strquery.trim())){
			strquery = strquery.replaceAll("\\|p\\|", "%");
