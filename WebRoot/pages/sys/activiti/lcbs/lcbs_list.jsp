...
<div class="page-containe ">
  <ul id="search_div" class="Huifold">
   <li class="item"> 
	...
	<div class="cl pd-5 bg-1 bk-gray div-btn"> <span class="l"><a href="javascript:;" id="del_button"   class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="member_add('流程部署','lcbs_edit.jsp?type=add','','210')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 新增流程</a></span> 
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="${pageContext.request.contextPath }/pages/sys/activiti/lcbs/lcbs_list.js"></script>
