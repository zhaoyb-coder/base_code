...
<div class="page-containe ">
  <ul id="search_div" class="Huifold">
   <li class="item"> 
	...
	<div class="cl pd-5 bg-1 bk-gray   div-btn"> 
		<span class="l">
		<a href="javascript:;" id="del_button"   class="btn btn-danger radius">
		<i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> 
		<a href="javascript:;" onclick="member_add('请假','qingjia_edit.jsp?type=add','','520')" class="btn btn-primary radius">
		<i class="Hui-iconfont">&#xe600;</i>请假</a></span>
		<a href="javascript:;" onclick="pop_show()"   class="btn btn-danger radius">
		<i class="Hui-iconfont">&#xe6e2;</i> 测试消息框</a> 
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="${pageContext.request.contextPath }/pages/sys/activiti/qingjia/qingjia_list.js"></script>
